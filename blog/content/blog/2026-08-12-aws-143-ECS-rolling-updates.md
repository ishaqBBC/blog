...
For context, ECS runs [Docker containers](https://magicishaqblog.netlify.app/2026-07-24-aws-140-docker-introduction/) as tasks, building on concepts from [EC2](https://magicishaqblog.netlify.app/2023-02-24-aws-10-EC2/) and cloud infrastructure fundamentals covered in [Getting Started](https://magicishaqblog.netlify.app/2023-01-23-aws-2-getting-started/).

## Introduction

Deploying new versions of [containerized applications](https://docs.docker.com/build/) presents a familiar challenge: how do you update running services without causing downtime? Amazon ECS addresses this through rolling updates, a controlled deployment mechanism that gradually replaces old task versions with new ones.
...
When you update an ECS service from version 1 to version 2, the service doesn't simply stop all containers and start new ones. Instead, it orchestrates a transition based on two parameters.
