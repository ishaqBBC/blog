...
Upload your files (e.g. index.html, {{your image}}.jpg) to an [S3 bucket](https://magicishaqblog.netlify.app/2025-28-03-aws-86-s3-security-bucket-policy/).

- Go to Properties > Static Website Hosting.

- Click Edit, enable hosting, and set index.html as the index document.

- Ensure all content is publicly readable via bucket policy.

- Copy your bucket website endpoint to access your site.
...
- Upload {{you_image}}.jpg (or any image file you wish to display).

- Upload index.html, which will serve as the homepage.

- Enable static website hosting

- In the [S3 bucket](https://magicishaqblog.netlify.app/2025-28-03-aws-86-s3-security-bucket-policy/) dashboard, go to the Properties tab.

- Scroll all the way down to Static website hosting and click Edit.

- Choose Enable, and set index.html as the index document.

- Click Save changes.

- Make your content public

- Static websites hosted on S3 must have public read access to display properly.

- If you’ve already configured a bucket policy to allow this (e.g. in a previous step), you’re good to go.

## Test the website

Once hosting is enabled, S3 provides a bucket website endpoint URL.

Copy this URL and paste it into your browser.

If all is set up correctly, you’ll see your website rendered, complete with text and images (like your coffee.jpg or {{your image}}.jpg).

Verify individual file access

You can right-click on any image and open it in a new tab to confirm that it’s accessible via a public URL.

## Conclusion

Congratulations! You’ve successfully set up a static website using Amazon S3. By uploading your content, enabling static hosting, and setting the right permissions, your site is now live and publicly accessible. This setup is ideal for simple websites, portfolios, or documentation pages.

Whether you're showcasing a vacation photo like {{your image}}.jpg or deploying a minimal homepage, S3’s static website hosting provides a dependable and budget-friendly solution.
