---
layout: blog
title: "AWS 95: Storage Classes - Hands On"
date: 2025-06-13T12:28:30.270Z
---


## TLDR

Walk through guide to create a storage class in Amazon s3
- create a bucket
- upload a file
...
- S3 permissions to create buckets and manage objects
- Basic knowledge of navigating the [AWS Console](https://magicishaqblog.netlify.app/2023-01-27-aws-3-UI-guide-and-walkthrough/)
...
2. Press **Upload** > **Add files**.
3. Select a file.

![Screenshot 3: Upload dialog with file selected](/blog/src/images/95/95-1.png)
...
1. Find your uploaded file in the object list.
2. Click its name to open details.
3. Scroll to **Properties** > **Storage class**.

![Screenshot 4: Object detail view showing 'Storage class: Standard'](/blog/src/images/95/95-2.png)

---

##  Change the Storage Class

1. In the object detail page, click **Edit storage class**.
2. Choose a new class:  
Try **One-Zone-IA** (stored in one Availability Zone only).
...
![Screenshot 7: Management tab with 'Create lifecycle rule'](/blog/src/images/95/95-3.png)

4. Name the rule:  
5. Apply it to **all objects** in the bucket.
6. Set transitions like this:

- Move to **Standard-IA** after 30 days  
- Move to **Intelligent-Tiering** after 60 days  
- Move to **Glacier Flexible Retrieval** after 180 days  

![Screenshot 8: Transition settings in rule configuration](blog/src/images/95/95-4.png)
...
- Created a bucket
- Uploaded an object
- Explored storage class types
- Changed an object’s storage class
- Created lifecycle rules to automate it

 [S3 storage classes documentation](blog/src/images/95/95-5.png)

 [AWS S3 Intelligent-Tiering](blog/src/images/95/95-6.png)

---


- Try enabling **versioning** to manage object history  
- Explore **S3 Glacier Deep Archive** for long-term storage  
- Monitor storage costs in [AWS Cost Explorer](https://aws.amazon.com/aws-cost-management/)
