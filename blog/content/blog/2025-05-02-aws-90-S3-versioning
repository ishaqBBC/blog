---
layout: blog
title: "AWS 90: S3 versioning"
date: 2025-05-02T08:46:54.136Z
---

## TLDR

[Amazon s3](https://magicishaqblog.netlify.app/2025-03-14-aws-84-Amazon-s3/) _versioning_ is a feature that helps you manage and protect your data by keeping multiple versions of your files. It allows you to recover from accidental deletions and roll back to earlier versions when needed. Versioning must be enabled at the [bucket](https://magicishaqblog.netlify.app/2025-04-04-aws-87-s3-bucket-hands-on/) level and can be suspended at any time without losing past versions.
...
- First Upload: The file is saved as version 1.

- Second Upload (Same File Key): S3 saves it as version 2, keeping version 1 intact.

- Deletion: If a file is deleted, S3 adds a delete marker instead of removing the file completely. The older versions are still there and recoverable.

This makes it a best practice for production environments and websites, because it gives you control, security, and peace of mind.

### Why use versioning?

Protection against accidental deletions: You can recover files, even if someone deletes them.

Easy rollback: Want to go back to how your site looked yesterday? Just restore the previous version.

Audit trail: You get a full history of file changes.

## Example of S3 Versioning

Let’s say you have an S3 [bucket](https://magicishaqblog.netlify.app/2025-04-04-aws-87-s3-bucket-hands-on/) named my-website-[bucket](https://magicishaqblog.netlify.app/2025-04-04-aws-87-s3-bucket-hands-on/). You enable versioning on this [bucket](https://magicishaqblog.netlify.app/2025-04-04-aws-87-s3-bucket-hands-on/).

You upload index.html. This is version 1.

You update index.html and re-upload it. Now S3 stores it as version 2.

You upload it again with more changes. That’s version 3.
