...
Which AWS service represents the easiest solution to address this use-case? </h4>
  ...
  <h4> Question: !@ A global e-commerce company wants to perform geographic load testing of its order processing API. The company must deploy resources to multiple AWS Regions to support the load testing of the API.
