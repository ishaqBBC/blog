---
layout: blog
title: "AWS 94: S3 Storage Classes"
date: 2025-05-30T08:13:21.478Z
---

## TLDR

[storage classes](https://magicishaqblog.netlify.app/2025-03-14-aws-84-Amazon-s3/) offers a range of [storage classes](https://aws.amazon.com/s3/storage-classes/) tailored to access frequency, cost-efficiency, and data durability. From hot data to cold archives, and from manual control to automatic tiering, understanding each storage class is key to both cost and performance. All [storage classes](https://aws.amazon.com/s3/storage-classes/) boast 11 nines of durability (99.999999999%), but availability, retrieval times, and costs vary. You can assign [storage classes](https://aws.amazon.com/s3/storage-classes/) manually or use S3 Lifecycle policies to automate transitions.

## What Are S3 Storage Classes?

[Storage classes](https://magicishaqblog.netlify.app/2025-03-14-aws-84-Amazon-s3/) allow you checkout how data is stored and retrieved based on how often you access it and how needed that data is. You’ll need to know these for both real-world application design and AWS certification exams.

## Durability vs Availability

Before diving into each class, it’s important to understand two foundational terms:
| Storage Class | Durability | Availability | Retrieval Time | Use Case |
| ---------------------------------- | ---------- | ------------ | --------------------- | ------------------------------------- |
| **Standard (General Purpose)** | 11 9s | 99.99% | Immediate | Big data, mobile apps, web hosting |
| **Standard-IA (Infrequent Access)** | 11 9s | 99.9% | Immediate | Backups, DR, infrequent reads |
| **One Zone-IA** | 11 9s | 99.5% | Immediate | Secondary backups, re-creatable data |
| **Glacier Instant Retrieval** | 11 9s | 99.9% | Milliseconds | Archived but occasionally needed data |
| **Glacier Flexible Retrieval** | 11 9s | 99.9% | 1 min to 12 hours | Archived data with flexible timing |
| **Glacier Deep Archive** | 11 9s | 99.9% | 12 to 48 hours | Long-term archives (e.g. 7+ years) |
| **Intelligent-Tiering** | 11 9s | 99.9% | Immediate to 48 hrs\* | Unknown access patterns |

\* Depends on tier (Frequent, Infrequent, Archive, Deep Archive)

![s3 [storage classes](https://aws.amazon.com/s3/storage-classes/) icon](/blog/src/images/94/94-1.png)

## Intelligent-Tiering

The Intelligent-Tiering class takes the guesswork out of data lifecycle management. AWS automatically moves objects across these sub-tiers:
...
Ideal when you're unsure of access patterns but want AWS to enhance cost automatically.

- Automating Class Transitions with Lifecycle Rules
  You don’t need to manually reclassify objects. Using [storage classes](https://magicishaqblog.netlify.app/2025-03-14-aws-84-Amazon-s3/) Lifecycle Policies, you can schedule transitions like:
...
This ensures lower costs over time without sacrificing data integrity.

[More Information on intelligent-Tiering](https://docs.aws.amazon.com/AmazonS3/latest/userguide/intelligent-tiering-overview.html)
